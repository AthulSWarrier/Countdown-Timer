...
class gui():
    def __init__(self):
        ...
        def start():
            ...
            while iterations > -1 and self.timer_pause_count == 0 and self.flag == 0: # remove flag if needed
