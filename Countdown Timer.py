...
class gui():
    def __init__(self):
        ...
        self.minute.set('00')
        self.seconds.set('00')
        hours = tk.Entry( self.box, font = ('bold',25) , text = self.hr , bg = '#C1C1CD')
        mins = tk.Entry( self.box, font  = ('bold',25) , text = self.minute , bg = '#C1C1CD')
        secs = tk.Entry( self.box, font  = ('bold',25) , text = self.seconds , bg = '#C1C1CD')
        ...
        self.hour_display.config(font = ('bold',18) , bg = '#C1C1CD')
        self.min_display.config(font = ('bold',18) , bg = '#C1C1CD')
        self.secs_display.config(font = ('bold',18) , bg = '#C1C1CD')
        ...
        self.resetbtn = tk.Button(self.box , text = 'RESET' , bg = 'OliveDrab1' , command = self.reset)
        self.resetbtn.place(x=20 , y = 110 ,width = 90 , height = 50)
        self.stopbtn = tk.Button(self.box , text = 'STOP' , bg = 'orangered2' , command = stop)
        self.stopbtn.place(x = 250 , y = 110 , width = 90 , height = 50)
        self.pausebtn = tk.Button(self.box , text = 'PAUSE' , bg = 'yellow' , command = Pause)
        self.pausebtn.place(x = 250 , y = 180 , width = 90 , height = 50)
        self.startbtn = tk.Button(self.box , text = 'START' , bg = 'mediumseagreen' , command = start)
        self.startbtn.place(x=135 , y = 145 , width = 90 , height = 50)
        self.resumebtn = tk.Button(self.box , text = 'RESUME' , bg = 'slategray' , command = resume)
        self.resumebtn.place(x = 20 , y = 180 , width = 90 , height = 50)
        self.box.mainloop()
